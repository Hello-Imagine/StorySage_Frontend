...
const Home: React.FC = () => {
  ...
  return (
    <div className="h-screen overflow-y-auto bg-gradient-to-b from-gray-100 to-blue-100 dark:from-gray-800 dark:to-blue-950">
      <div className="container mx-auto py-20 px-10">
        <Row gutter={16}>
          ...
          >
            <h1 className="p-2 text-5xl font-bold font-serif text-blue-800 dark:text-blue-300">
              Life Trail AI
            </h1>
        ...
        <Row className="mt-12">
          <Col span={24} className="flex justify-center">
            <div className="max-w-2xl w-full">
              <h2 className="text-3xl font-serif text-center mb-8 text-blue-800 dark:text-blue-300">
                How It Works
              </h2>
              <Timeline
                items={[
